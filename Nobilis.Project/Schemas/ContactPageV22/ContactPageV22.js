define("ContactPageV22", ["BaseFiltersGenerateModule", "BusinessRuleModule", "ContactPageV2Resources",
		...
		diff: /**SCHEMA_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"controlConfig": {
						"autocomplete": "f537e2e7-9490-41db-8717-6a57ecbf9bd7"
					}
				},
				"parentName": "ProfileContainer",
				"propertyName": "items",
			...
			},
			{
				...
				"values": {
					...
					"controlConfig": {
						"autocomplete": "034fdaee-19f9-4c6a-bc3a-0dc17995ff29"
					}
				},
				"parentName": "ProfileContainer",
				"propertyName": "items",
			...
			},
			{
				...
				"values": {
					...
					"controlConfig": {
						"autocomplete": "14064106-26d7-4ae9-8457-03b294b7e086"
					}
				},
				"parentName": "ProfileContainer",
				"propertyName": "items",
